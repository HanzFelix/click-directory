...
<template>
  ...
  >
    ...
    >
      ...
      />
      <div
        class="material-icons peer h-6 w-12 rounded-full bg-slate-400 bg-opacity-100 transition-colors after:absolute after:-top-1 after:-left-2 after:h-8 after:w-8 after:rounded-full after:border-2 after:border-transparent after:bg-slate-600 after:pt-0.5 after:text-center after:text-slate-200 after:transition-all after:content-['drive\_file\_rename\_outline'] peer-checked:bg-opacity-0 peer-checked:after:translate-x-full peer-checked:after:bg-slate-400 peer-checked:after:text-slate-600 peer-checked:after:content-['lock'] peer-checked:hover:bg-slate-400 peer-checked:after:hover:bg-slate-600 peer-checked:hover:after:text-slate-200 peer-focus:after:bg-slate-600 peer-focus:after:text-slate-200 dark:bg-slate-600 dark:after:bg-slate-200 dark:after:text-slate-600 dark:peer-checked:after:bg-slate-600 dark:peer-checked:after:text-slate-200 dark:peer-checked:hover:bg-slate-600 dark:peer-checked:after:hover:bg-slate-200 dark:peer-checked:hover:after:text-slate-600 dark:peer-focus:after:bg-slate-200 dark:peer-focus:after:text-slate-600"
      ></div>
    </label>
    <span
      class="peer/a ml-3 text-sm font-semibold text-slate-800 transition-opacity peer-hover/a:opacity-100 dark:text-slate-300"
